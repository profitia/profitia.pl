...
export const CAPABILITIES: Capability[] = [
...

  {
    ...
    shortDescription: {
      pl: 'Kompleksowa diagnoza dojrzałości całej funkcji zakupowej, która pokazuje właściwy punkt startu dla usprawnień.',
      en: 'A comprehensive assessment of procurement function maturity that shows the right starting point for improvement.',
    },
    longDescription: {
      pl: 'SPOT to kompleksowa diagnoza dojrzałości funkcji zakupowej realizowana w ciągu 3–4 tygodni. Łączymy analizę danych i dokumentów z wywiadami eksperckimi, oceniając ponad 80 aspektów działania zakupów w obszarach Sourcingu, Procesów, Organizacji i Narzędzi. Efektem jest czytelna ocena dojrzałości, raport luk oraz lista priorytetów i rekomendowanych kolejnych działań.',
      en: 'SPOT is a comprehensive procurement maturity assessment delivered over 3–4 weeks. We combine data and document analysis with expert interviews, assessing 80+ aspects of procurement across Sourcing, Processes, Organisation, and Tools. The result is a clear maturity assessment, a gap report, and a prioritised set of recommended next actions.',
    },
    whatItSolves: [
    ...
    methodology: [
      { pl: 'Ustalenie zakresu badania oraz zebranie danych, procedur i przykładów postępowań', en: 'Definition of the assessment scope and collection of data, procedures, and procurement case examples' },
      { pl: 'Wywiady z zespołem zakupowym i kluczowymi interesariuszami', en: 'Interviews with the procurement team and key stakeholders' },
      { pl: 'Ocena ponad 80 aspektów w czterech obszarach dojrzałości zakupowej', en: 'Assessment of 80+ aspects across four procurement maturity areas' },
      { pl: 'Raport luk, priorytetów i rekomendowanych kolejnych działań', en: 'Gap report, priorities, and recommended next actions' },
    ],
    engagement: {
