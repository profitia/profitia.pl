...
export const WIDGET_REGISTRY: ContextualWidget[] = [
...

  {
    ...
    cta: { label: "Zobacz Benchmarking Dostawców", url: "/services/supplier-benchmarking", type: "service_order" },
    priority: 9,
  ...
  },
  {
    ...
    cta: { label: "See Supplier Benchmarking", url: "/services/supplier-benchmarking", type: "service_order" },
    priority: 9,
    tags: ["benchmark", "savings", "year1", "negotiation"],
  },
...

  {
    ...
    content: "W organizacjach z podobnym profilem zakupowym pierwszym krokiem jest często Analiza SPOT — kompleksowa diagnoza dojrzałości, która pokazuje, gdzie problem naprawdę się zaczyna i co warto zrobić najpierw.",
  ...
  },
  {
    ...
    content: "In organisations with a similar procurement profile, the first step is often SPOT Analysis — a comprehensive maturity assessment that shows where the real problem starts and what should happen first.",
